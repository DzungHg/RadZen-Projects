    ...
    public class TblGnGenders : QuanLyBanHang.Pages.TblGnGendersComponent
    {
        ...
        protected override void BuildRenderTree(Microsoft.AspNetCore.Components.RenderTree.RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(2, "ChildContent", (Microsoft.AspNetCore.Components.RenderFragment)((builder2) => {
                ...
                builder2.AddAttribute(6, "Text", "Tbl Gn Genders");
...
#line hidden
                ...
                builder2.OpenComponent<Radzen.Blazor.RadzenGrid<TblGnGender>>(22);
...
#line hidden
                ...
                builder2.AddAttribute(26, "Data", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<System.Collections.Generic.IEnumerable<TblGnGender>>(
#line 16 "F:\GitHub02\RadZen-Projects\QuanLyBanHang\server\Pages\TblGnGenders.razor"
...
#line hidden
                ...
                builder2.AddAttribute(27, "RowSelect", Microsoft.AspNetCore.Components.CompilerServices.RuntimeHelpers.TypeCheck<Microsoft.AspNetCore.Components.EventCallback<TblGnGender>>(Microsoft.AspNetCore.Components.EventCallback.Factory.Create<TblGnGender>(this, 
#line 16 "F:\GitHub02\RadZen-Projects\QuanLyBanHang\server\Pages\TblGnGenders.razor"
                                                                                                                                                                                 Grid0RowSelect
...
#line hidden
                ...
                builder2.AddAttribute(28, "Columns", (Microsoft.AspNetCore.Components.RenderFragment)((builder3) => {
                    ...
                    builder3.OpenComponent<Radzen.Blazor.RadzenGridColumn<TblGnGender>>(30);
                    builder3.AddAttribute(31, "Property", "Gender_SEQ");
                    builder3.AddAttribute(32, "Title", "Gender SEQ");
                    builder3.AddAttribute(33, "Type", "integer");
                    builder3.CloseComponent();
                    builder3.AddMarkupContent(34, "\n            ");
                    builder3.OpenComponent<Radzen.Blazor.RadzenGridColumn<TblGnGender>>(35);
                    builder3.AddAttribute(36, "Property", "Gender_ID");
                    builder3.AddAttribute(37, "Title", "Gender ID");
                    builder3.AddAttribute(38, "Type", "string");
                    builder3.CloseComponent();
                    builder3.AddMarkupContent(39, "\n            ");
                    builder3.OpenComponent<Radzen.Blazor.RadzenGridColumn<TblGnGender>>(40);
                    builder3.AddAttribute(41, "Property", "Gender");
                    builder3.AddAttribute(42, "Title", "Gender");
                    builder3.AddAttribute(43, "Type", "string");
                    builder3.CloseComponent();
                    builder3.AddMarkupContent(44, "\n            ");
                    builder3.OpenComponent<Radzen.Blazor.RadzenGridColumn<TblGnGender>>(45);
...
#line hidden
                    ...
                    builder3.AddAttribute(50, "Template", (Microsoft.AspNetCore.Components.RenderFragment<TblGnGender>)((tblGnGender) => (builder4) => {
